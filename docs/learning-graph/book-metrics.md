...
| 2 | Chapters | 0 | Required ⚠️ | Chapter directories with index.md |
| 3 | MicroSims | 8 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 0 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 0 / 0 | Recommended | Chapters with a quiz.md (0 questions total) |
| 6 | Chapter References | 0 / 0 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 47 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 0 | Recommended | Questions in faq.md |
| 9 | Words | 32,699 | Required | Words across student-facing markdown |
...
| Total Words | 32,699 | 0 | Words in markdown files |
| Links | 275 | 0 | Hyperlinks in markdown format |
| Equivalent Pages | 134 | 4 | Estimated pages (250 words/page + visuals) |
