...
|---|---------|-------|--------|-------|
| 1 | Concepts | 266 | Required | Concepts from learning graph |
| 2 | Chapters | 19 | Required | Chapter directories with index.md |
| 3 | MicroSims | 64 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 0 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 0 / 19 | Recommended | Chapters with a quiz.md (0 questions total) |
| 6 | Chapter References | 0 / 19 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 400 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 84 | Recommended | Questions in faq.md |
| 9 | Words | 172,374 | Required | Words across student-facing markdown |
| 10 | Mascot | 8 | Optional | Mascot image poses in docs/img/mascot/ |
...
|-------------|-------------|---------------|-------|
| Diagrams | 57 | 57 | H4 headers starting with '#### Diagram:' |
| Equations | 2 | 1 | LaTeX expressions (inline and display) |
| Total Words | 172,374 | 102,362 | Words in markdown files |
| Links | 683 | 131 | Hyperlinks in markdown format |
| Equivalent Pages | 735 | 455 | Estimated pages (250 words/page + visuals) |
