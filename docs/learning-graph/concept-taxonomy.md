...
16 categories covering the 410 concepts in [concept-list.md](./concept-list.md). No category exceeds
30% of the total (largest is FOUND at 14.9%).
...
| QUAL | Graph Quality & Validation | 45 | DAG validation, cycle/orphan detection, connectivity, quality metrics, and graph-metric analysis (centrality, diameter, density, PageRank-style recursive importance, Concept Impact Score) |
...
| TEXTBOOK | Intelligent Textbooks & MicroSims | 18 | Intelligent textbook generation, MicroSims, book-build workflow/metrics, and CIS-driven chapter partitioning, concept ordering, and content-budget allocation |
